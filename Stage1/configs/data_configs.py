...
DATASETS = {
	'ffhq_encode': {
		'transforms': transforms_config.EncodeTransforms_vgg,
	...
	'nabirds_encode': {
		...
		'train_source_root': dataset_paths['nabirds'],
		'train_target_root': dataset_paths['nabirds'],
		'test_source_root': dataset_paths['nabirds'],
		'test_target_root': dataset_paths['nabirds'],
	},
	'flowers_encode': {
		'transforms': transforms_config.EncodeTransforms,
	...
	'vggfaces_encode': {
		...
		'test_source_root': dataset_paths['vgg_faces_train'],
		'test_target_root': dataset_paths['vgg_faces_train'],
	},
    'vggfaces_encode_eva': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['vgg_faces_test'],
		'train_target_root': dataset_paths['vgg_faces_test'],
