...
class LatentDiffusion(DDPM):
    ...
    def get_learned_conditioning(self, c, input_feature=False, input_code=False):

        if self.cond_stage_forward is None:
            if hasattr(self.cond_stage_model, 'encode') and callable(self.cond_stage_model.encode):
                c = self.cond_stage_model.encode(c, input_feature=input_feature, input_code=input_code, device=self.device)
