...
from datasets_hae.inference_dataset import InferenceDataset
...
def run():
    ...
    for input_batch in tqdm(dataloader):
        ...
        for i in range(opts.test_batch_size):
            ...
            # print(im_path)
            results.append(
                str(result_batch[2][i].cpu().numpy()) + ' ' + str(label[i].cpu().numpy()))
            ...
            im_save_path = os.path.join(
                out_path_results, os.path.basename(im_path))
