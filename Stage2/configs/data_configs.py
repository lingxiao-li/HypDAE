...
DATASETS = {
    ...
    'vggfaces_encode_eva': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['vgg_faces_train_eva'],
		'train_target_root': dataset_paths['vgg_faces_train_eva'],
		'test_source_root': dataset_paths['vgg_faces_test_eva'],
		'test_target_root': dataset_paths['vgg_faces_test_eva'],
	},
