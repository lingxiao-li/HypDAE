...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            '--checkpoint_path', default=None, type=str, help='Path to pSp model checkpoint')
        ...
        self.parser.add_argument('--input_latent', action='store_false',
                                 help='Whether to input a latent code rather than an image')
        ...
        self.parser.add_argument('--n_outputs_to_generate', type=int,
                                 default=5, help='Number of outputs to generate per input image.')
        self.parser.add_argument(
